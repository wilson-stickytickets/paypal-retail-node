...
module.exports = {
    ...
    configure: function configure(environment, options) {
        ...
        if (!options.scopes) {
            options.scopes = 'openid email https://uri.paypal.com/services/paypalhere https://api.paypal.com/v1/payments/.* https://uri.paypal.com/services/paypalattributes/business';
        }
